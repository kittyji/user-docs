...
To understand the **Merge** function, you must first understand [the quadtree structure](downloadable-assets.md#lots) and [the OBJ file naming principle in model.zip](downloadable-assets.md#lod).
...
If you want to learn more about how to convert **a full OBJ project** into **DAE**, please take a look at [this article](import-to-sketchup.md#full-dae).
